...
//go:generate swagger generate server --target ../../gen --name MilmoveOrders --spec ../../../swagger/orders.yaml --api-package ordersoperations --model-package ordersmessages --server-package ordersapi --exclude-main

func configureFlags(api *ordersoperations.MilmoveOrdersAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *ordersoperations.MilmoveOrdersAPI) http.Handler {
	...
	if api.GetOrdersCountByIssuerHandler == nil {
		api.GetOrdersCountByIssuerHandler = ordersoperations.GetOrdersCountByIssuerHandlerFunc(func(params ordersoperations.GetOrdersCountByIssuerParams) middleware.Responder {
